  ...
  return (
    <form className="flex flex-col justify-center items-center" onSubmit={onSubmit}>
      <input
        ...
        className="border border-gray-300 bg-white rounded px-4 py-2 w-full max-w-md text-white placeholder:text-black h-20 md:h-24 focus:outline-none focus:ring-0"
      />
      <button
        type="submit"
